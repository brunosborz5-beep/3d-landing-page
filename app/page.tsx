    ...
    <>
      ...
      <main className="folios">
        ...
        <section className="folio" id="onde-quando" aria-labelledby="folio-1-titulo">
          ...
          <p className="folio-lead">
            Um cartório antigo de nome, mas com portas sempre abertas para quem precisa. Veja
            nosso endereço, horários e onde estacionar com tranquilidade.
          </p>
          ...
          <div className="tabelia">
            ...
            <div className="tabelia-texto">
              ...
              <p>
                ...
                rigor que a fé pública exige e o cuidado de quem conhece cada história por trás de
                cada documento. Sua porta está sempre aberta para orientar, explicar e resolver —
                com a segurança de quem faz isso todos os dias, há anos, para a nossa cidade.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="folio" id="servicos" aria-labelledby="folio-4-titulo">
          ...
          <p className="folio-lead">
            Sem juridiquês: aqui está, em bom português, o que resolvemos no dia a dia do
            cartório.
          </p>

          {/* Serviço 1 — Reconhecimento de firma */}
          <div className="servico-bloco">
            <h3>Reconhecimento de firma</h3>
            <p className="frase">Certificamos que aquela assinatura é mesmo sua.</p>
            <div className="cena cena--firma" data-anim="once">
              <div className="doc">
              ...
              <svg className="seta-firma" viewBox="0 0 100 70" aria-hidden="true">
                <path d="M10 8 Q 55 8 70 55" />
              </svg>
            </div>
          </div>

          {/* Serviço 2 — Apostilamento de Haia */}
          <div className="servico-bloco">
            <h3>Apostilamento de Haia</h3>
            <p className="frase">
              Damos validade internacional a documentos brasileiros, para uso em países que aceitam
              a Convenção da Apostila.
            </p>
            <div className="cena cena--apostila" data-anim="loop">
              <div className="doc2">
                <div className="doc-linha" />
                <div className="doc-linha" />
                <div className="doc-linha curta" />
                <div className="carimbo-apostila">APOSTILA</div>
              </div>
              <svg className="aviao-solo" viewBox="0 0 40 40" aria-hidden="true">
                <path
                  d="M4 22l32-16-12 32-4-12-16-4Z"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.8"
                  strokeLinejoin="round"
              ...
              <div className="globo-orbita">
                <svg className="globo" viewBox="0 0 100 100" aria-hidden="true">
                  <circle cx="50" cy="50" r="40" />
                  <ellipse cx="50" cy="50" rx="18" ry="40" />
                  <ellipse cx="50" cy="50" rx="40" ry="18" />
                </svg>
                <div className="orbita orbita-1">
                  <svg className="aviao-mini" viewBox="0 0 40 40" aria-hidden="true">
                    <path
                      d="M4 22l32-16-12 32-4-12-16-4Z"
                      fill="none"
                      stroke="currentColor"
          ...
          {/* Serviço 3 — Protesto de títulos */}
          <div className="servico-bloco">
            <h3>Protesto de títulos</h3>
            <p className="frase">
              Registramos, consultamos e ajudamos a cancelar dívidas em aberto, com transparência
              do início ao fim.
            </p>
            <div className="cena cena--protesto" data-anim="once">
              <div className="doc3">
                <div className="doc-linha" />
                <div className="doc-linha" />
                <div className="doc-linha curta" />
        ...
        <section className="folio" id="contato" aria-labelledby="folio-6-titulo">
          ...
          <p className="folio-lead">
            Dúvidas sobre valores, prazos ou requisitos de um ato específico? Fale com a gente pelo
            WhatsApp ou venha até o cartório.
          </p>
          <div className="contato-bloco">
            <a className="whatsapp-botao" href="https://wa.me/554735212063" target="_blank" rel="noopener noreferrer">
      ...
      >
        ...
        <svg className="aurora-avatar" viewBox="0 0 60 60" aria-hidden="true">
          ...
          <path
            d="M12 52c1-11 8-17 18-17s17 6 18 17"
            fill="currentColor"
            opacity="0.85"
          />
        </svg>
